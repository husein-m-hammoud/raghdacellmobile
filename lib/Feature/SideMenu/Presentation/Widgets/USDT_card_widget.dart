...
class USDTCardWidget extends StatefulWidget {
  const USDTCardWidget(
      {super.key, required this.ustdText, required this.usdtTaxPercentage});
  final String ustdText;
  final String usdtTaxPercentage;
  @override
  State<USDTCardWidget> createState() => _USDTCardWidgetState();
}

class _USDTCardWidgetState extends State<USDTCardWidget> {
  GlobalKey<FormState> globalKey = GlobalKey<FormState>();
  File? imageFile;
  late final TextEditingController linkController =
      TextEditingController(text: widget.ustdText);
              ...
              onChanged: (p0) {
                if (p0 != "") {
                  ...
                  double percentageValue =
                      double.parse(widget.usdtTaxPercentage) / 100.0;
                  int result =
